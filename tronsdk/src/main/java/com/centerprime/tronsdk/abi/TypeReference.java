 ...
 * This is so that we can pass around Typed {@link com.centerprime.tronsdk.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends com.centerprime.tronsdk.abi.datatypes.Type>
    ...
    public static <T extends com.centerprime.tronsdk.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.centerprime.tronsdk.abi.datatypes.Type>
