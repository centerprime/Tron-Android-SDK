...
public final class DatabaseGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage,
      com.centerprime.tronsdk.api.GrpcAPI.BlockReference> METHOD_GET_BLOCK_REFERENCE = getGetBlockReferenceMethod();

  private static volatile io.grpc.MethodDescriptor<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage,
      com.centerprime.tronsdk.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage,
      com.centerprime.tronsdk.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod() {
    io.grpc.MethodDescriptor<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage, com.centerprime.tronsdk.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod;
      ...
      synchronized (DatabaseGrpc.class) {
        if ((getGetBlockReferenceMethod = DatabaseGrpc.getGetBlockReferenceMethod) == null) {
          DatabaseGrpc.getGetBlockReferenceMethod = getGetBlockReferenceMethod = 
              io.grpc.MethodDescriptor.<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage, com.centerprime.tronsdk.api.GrpcAPI.BlockReference>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.centerprime.tronsdk.api.GrpcAPI.BlockReference.getDefaultInstance()))
  ...
  public static final io.grpc.MethodDescriptor<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage,
      com.centerprime.tronsdk.protos.Protocol.DynamicProperties> METHOD_GET_DYNAMIC_PROPERTIES = getGetDynamicPropertiesMethod();

  private static volatile io.grpc.MethodDescriptor<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage,
      com.centerprime.tronsdk.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage,
      com.centerprime.tronsdk.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod() {
    io.grpc.MethodDescriptor<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage, com.centerprime.tronsdk.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod;
      ...
      synchronized (DatabaseGrpc.class) {
        if ((getGetDynamicPropertiesMethod = DatabaseGrpc.getGetDynamicPropertiesMethod) == null) {
          DatabaseGrpc.getGetDynamicPropertiesMethod = getGetDynamicPropertiesMethod = 
              io.grpc.MethodDescriptor.<com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage, com.centerprime.tronsdk.protos.Protocol.DynamicProperties>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.centerprime.tronsdk.protos.Protocol.DynamicProperties.getDefaultInstance()))
  ...
  public static abstract class DatabaseImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getBlockReference(com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<com.centerprime.tronsdk.api.GrpcAPI.BlockReference> responseObserver) {
      asyncUnimplementedUnaryCall(getGetBlockReferenceMethod(), responseObserver);
    }

    /**
     */
    public void getDynamicProperties(com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<com.centerprime.tronsdk.protos.Protocol.DynamicProperties> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.centerprime.tronsdk.api.GrpcAPI.BlockReference>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage,
                com.centerprime.tronsdk.protos.Protocol.DynamicProperties>(
  ...
  public static final class DatabaseBlockingStub extends io.grpc.stub.AbstractStub<DatabaseBlockingStub> {
     ...
     * </pre>
     */
    public com.centerprime.tronsdk.api.GrpcAPI.BlockReference getBlockReference(com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage request) {
    ...
    /**
     */
    public com.centerprime.tronsdk.protos.Protocol.DynamicProperties getDynamicProperties(com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage request) {
      return blockingUnaryCall(
  ...
  public static final class DatabaseFutureStub extends io.grpc.stub.AbstractStub<DatabaseFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.centerprime.tronsdk.api.GrpcAPI.BlockReference> getBlockReference(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.centerprime.tronsdk.protos.Protocol.DynamicProperties> getDynamicProperties(
        com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BLOCK_REFERENCE:
          serviceImpl.getBlockReference((com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage) request,
              (io.grpc.stub.StreamObserver<com.centerprime.tronsdk.api.GrpcAPI.BlockReference>) responseObserver);
          break;
        case METHODID_GET_DYNAMIC_PROPERTIES:
          serviceImpl.getDynamicProperties((com.centerprime.tronsdk.api.GrpcAPI.EmptyMessage) request,
              (io.grpc.stub.StreamObserver<com.centerprime.tronsdk.protos.Protocol.DynamicProperties>) responseObserver);
          break;
